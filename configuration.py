...
data_arg.add_argument('--sr', type=int, default=22050, help="sampling rate")
data_arg.add_argument('--nfft', type=int, default=2048, help="fft kernel size")
data_arg.add_argument('--window', type=int, default=0.05, help="window length (ms)")
data_arg.add_argument('--hop', type=int, default=0.0125, help="hop size (ms)")
